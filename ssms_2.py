...
def pick_sql_version(instance_name):  # might be redundant
    ...
    path = '"C:/Program Files (x86)/Microsoft SQL Server/{}/Tools/Binn/ManagementStudio/Ssms.exe -S '.format(version_d.get(sql_version, '120'))
